"""findmytutor_20959 URL Configuration
...
admin.site.site_header = "FindMyTutor"
admin.site.site_title = "FindMyTutor Admin Portal"
admin.site.index_title = "FindMyTutor Admin"

# swagger
api_info = openapi.Info(
    title="FindMyTutor API",
    default_version="v1",
    description="API documentation for FindMyTutor App",
)
